...
conn.sendHydrated2(m.chat, `DONE:` + ' ' + name, cap, x.result.Normal_video, 'https://instagram.com/mydiam.is.fun', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', 'https://youtube.com/@zykobotz', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', [['Donasi', `.donasi`],
  ['Owner', `.owner`]], m)
}
